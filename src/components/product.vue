      ...
      <div class="common_state" data-space-bottom="2rem">
        <div class="row horizontal v_center">
          ...
          <el-select v-model="products" size="small" data-space-left="1rem" width="30">
            <el-option v-for="item in productsList" :key="item.value" :label="item.label" :value="item.value"></el-option>
          </el-select>
            ...
            <el-dialog v-model="dialogProductVisible" :title="dialogTitle" width="500px">
              ...
              <template #footer>
                <span class="dialog-footer">
                  ...
                  <el-button type="primary" @click="dialogProductVisible = false">確定</el-button>
                </span>
              </template>
            </el-dialog>
          </div>
