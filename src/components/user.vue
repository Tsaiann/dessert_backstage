      ...
      <div class="common_data">
        <div class="row horizontal v_center" data-space-bottom="1rem">
          ...
          <el-select v-model="pagination" size="small">
            <el-option v-for="item in userPagination" :key="item.value" :label="item.label" :value="item.value"></el-option>
          </el-select>
                ...
                <div class="row horizontal center">
                  ...
                  <el-dialog v-model="dialogUserVisible" title="查看會員" width="500px">
                    ...
                    <el-form :model="UserForm">
                      ...
                      <el-pagination :page-size="10" :pager-count="11" layout="prev, pager, next" :total="100"></el-pagination>
...
export default {
  ...
  setup() {
    ...
    const deleteUser = () => {
      ElMessageBox.confirm('確定要刪除會員資料？', '警告', {
